...
Once the terms are computed, these are used as features for each point in space. Based on these features in a Gaussian Mixture Modeling. And the rest of the Callaham et al. method is applied as before.
